...
export const CompanyLogo: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M50 20L85 80H15L50 20Z" fill="#eab308"/>
    <path d="M50 35L75 75H25L50 35Z" fill="#1e3a8a"/>
    <path d="M50 45L65 70H35L50 45Z" fill="#eab308"/>
  </svg>
);
...
export const ClipboardDocumentCheckIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.125 2.25h-4.5c-1.125 0-2.062.938-2.062 2.063v15.375c0 1.125.938 2.063 2.063 2.063h12.75c1.125 0 2.063-.938 2.063-2.063V12.375m-15-9.375h15m-1.5 0-1.5-1.5m0 0h-3l-1.5 1.5m0 0-1.5-1.5m1.5 1.5v3.375m.75-3.375-3 3m0 0-3-3m3 3v6.75m0-6.75h3.375m-3.375 0h-3.375" />
        <path strokeLinecap="round" strokeLinejoin="round" d="m16.864 13.5 2.25 2.25 4.5-4.5" />
    </svg>
);
...
export const SunIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m0 13.5V21m8.966-8.966h-2.25M4.293 12.034H2.043m15.356-7.071-1.591 1.591M6.207 17.793l-1.591 1.591m12.728 0-1.591-1.591M6.207 6.207 4.616 4.616M9.75 12a2.25 2.25 0 1 1 4.5 0 2.25 2.25 0 0 1-4.5 0Z" />
  </svg>
);
